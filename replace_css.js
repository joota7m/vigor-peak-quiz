...
const startStr = "        /* COMMENTS SECTION */";
const endStr = "        /* NO MORE COMMENTS */";

const startIdx = text.indexOf(startStr);
const endIdx = text.indexOf(endStr);

if (startIdx !== -1 && endIdx !== -1) {
    const newText = text.substring(0, startIdx) + newCss + text.substring(endIdx);
    fs.writeFileSync('index.html', newText, 'utf-8');
    console.log("Replaced CSS successfully with Node.");
} else {
